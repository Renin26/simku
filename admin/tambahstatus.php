      ...
      <div id="content">
        ...
        <div class="card shadow mb-2">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Tambah Data Status</h6>
            </div>
            <div class="card-body">
        <div class="container-fluid">
            <form action="proses-tbh-status.php" method="post">
                <div class="form-group row">
                  <label class="col-sm-2 col-form-label">Keterangan status</label>
                  <div class="col-sm-6">
