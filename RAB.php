...
<!-- End of Topbar -->
        ...
        <div class="container-fluid">
          ...
          <a href="biaya.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fa-sm text-white-50"></i>Jumlah Biaya Pekerjaan</a>&nbsp;
          <a href="bahan.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fa-sm text-white-50"></i>Transaksi Bahan Bangunan</a>
