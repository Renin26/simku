...
<table width="760" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr height="46">
                <td width="10%"> </td>
                <td width="25%"> </td>
                <td width="65%"><font color="black" size="4" ><strong>Transaksi Bahan Bangunan</strong></font></td>
        </tr>
        <tr height="46">
            <td> </td>
            <td>id_proyek</td>
  ...
  ?>
        ...
        <tr height="46">
            ...
            <td><input type="text" name="nama_bahan" size="35" /></td>
        </tr>
        <tr height="46">
            <td> </td>
            <td>Jumlah</td>
            <td><input type="number" name="jumlah" size="50" onkeyup="sum();" id="satuan" /></td>
        </tr>
        <tr height="46">
            <td> </td>
            <td>Satuan</td>
            <td><input type="text" name="satuan" size="50" /></td>
        </tr>
    <tr height="46">
            <td> </td>
            <td>Harga Satuan (Rp)</td>
            <td><input type="number" name="harga_satuan" size="50" onkeyup="sum();"  id="harga_satuan"/></td>
        </tr>
	<tr height="46">
            <td> </td>
            <td>Total Harga (Rp)</td>
            <td><input type="text" name="harga_total" size="50" maxlength="30" id="hasil" readonly="readonly"/></td>
        </tr>
     <tr height="46">
            <td> </td>
            <td> </td>
  ...
  <script src="js/demo/chart-pie-demo.js"></script>
		  ...
		  <script>
				function sum(){
					...
					var txtharga = document.getElementById('harga_satuan').value;
				var hasil = (txtsatuan)*(txtharga)
