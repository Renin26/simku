        ...
        <form method="post">
              <input type="hidden" name="id" value="<?php echo $data['id_projek'];?>">
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="nama_proyek" value="<?php echo $data['nama_proyek']?>" class="form-control" size="4" disabled>
                  </div>
                </div>
                <div class="form-group row">
                  <label class="col-sm-2 col-form-label">Nama Mandor :</label>
                  <div class="col-sm-10">
                    <input type="text" name="nama_mandor" value="<?php echo $data['nama_mandor']?>" class="form-control" disabled>
                  </div>
                </div>
                <div class="form-group row">
                  <label class="col-sm-2 col-form-label">Lokasi Proyek</label>
                  <div class="col-sm-10">
                    <input type="text" name="lokasi" value="<?php echo $data['lokasi']?>" class="form-control" disabled>
                  </div>
                </div>
                <div class="form-group row">
                  <label class="col-sm-2 col-form-label">Luas Proyek</label>
                  <div class="col-sm-10">
                    <input type="text" name="luas" value="<?php echo $data['luas']?>" class="form-control" disabled>
                  </div>
                </div>
                <div class="form-group row">
                  <label class="col-sm-2 col-form-label">Tanggal Dimulai</label>
                  <div class="col-sm-10">
                    <input type="text" name="tanggal" value="<?php echo $data['tanggal']?>" class="form-control" disabled>
                  </div>
            <div class="form-group row">
                  <label class="col-sm-2 col-form-label">&nbsp;</label>
                  <div class="col-sm-10">
                    <a class="btn btn-primary" href="jalan.php">Kembali</a>
                  </div>
                </div>
